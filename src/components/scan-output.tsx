...
function ToolCallBlock({ item }: { item: OutputItem }) {
  ...
  const isReportVuln = item.label === "report_vulnerability";

  return (
    <div
      style={{
        margin: "10px 0",
        borderLeft: `2px solid ${isReportVuln ? "#ff8c00" : "#4a9eff"}`,
        paddingLeft: "12px",
      }}
    >
      <div
        style={{
          ...
          color: isReportVuln ? "#ff8c00" : "#4a9eff",
          fontSize: "10px",
      ...
      >
        {!hasContent && !isRunning && (
          ...
          >
            ...
            {(
              [
                { key: "l0", text: "Configure a target and launch a scan." },
                { key: "l1", text: "" },
                { key: "l2", text: "The AI agent will autonomously:" },
                { key: "l3", text: "  - Enumerate the attack surface" },
                {
                  key: "l4",
                  text: "  - Test for OWASP Top 10 vulnerabilities",
                },
                {
                  key: "l5",
                  text: "  - Execute security tools (nmap, nuclei, etc.)",
                },
                {
                  key: "l6",
                  text: "  - Report findings with evidence and PoC",
                },
                { key: "l7", text: "" },
                { key: "l8", text: "All findings appear in the panel below." },
